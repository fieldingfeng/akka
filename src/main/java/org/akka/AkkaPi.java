...
public class AkkaPi {
    ...
    public static void main(String[] args) throws InterruptedException {
        AkkaPi pi = new AkkaPi();
        int numStepsPerComp = 10000;
        int numJobs = 100000;
        latch = new CountDownLatch(1);
        pi.calculate(4, numStepsPerComp, numJobs);
        latch.await();
        
        System.out.println(timSum / 1000 / 1000);
    }
    ...
    public static class Master extends UntypedActor {
        ...
        public Master(
            ...
            workerRouter = this.getContext().actorOf(Props.create(Worker.class).withRouter(
    ...
    public void calculate(
        ...
        ActorRef master = system.actorOf(Props.create(
        		Master.class, nrOfWorkers, nrOfMessages, nrOfElements, listener), "master");
